...
export const Geumseong = () => {
  ...
  const data = [
    /* 
      필독 !!!
      1. img1, im2는 파일에서 임폴트해와야 함(확장자 꼭 png로 바꾸기!)
      2. 만약 사진 화질이 안좋다면 하나만 넣자! 
      (화질이 좋아도 하나만 넣는게 더 예뻐보이는데? 하면 하나만 넣고 가끔씩은 이렇게 해주세요)
      3. 다 넣고 만약 여행지가 없는 면이 있다면 정리해서 알려주기
      4. 작업방식 :  필요한 사진들 확장자 변경 및 임폴트(웹 링크 X)
                    import img1 from "경로" 한뒤 
                    아래에 있는 data에 img1 : img1 이런식으로 추가하면 됨
                  => const data 선언하여 아래형식에 맞추어 데이터 생성
                  => return 문 안에 h1 태그 밑에 <ul>...</ul> 복붙
                  => 반복
      5. 혹시 모르는 것 or 이렇게 하면 좋겠다 싶은 의견이 있다면 말해주세요.
    */
    {
      name : "조문국 박물관",
      address : "금성면 초전리",
      ...
      img1 : "https://cdn.discordapp.com/attachments/810494124184698904/991869865965142056/50b2d90f-6c6b-479f-80ab-07722ff32a6a.png",
      img2 : "https://cdn.discordapp.com/attachments/810494124184698904/991869803692294284/restmb_allidxmake.png"
    },
    {
      name : "조문국 사적지",
      address : "금성면 동부로",
      ...
      img1 : "https://cdn.discordapp.com/attachments/810494124184698904/991874688999505971/996118335B08089424.png"
    },
    {
      name : "탑리마을",
      address : "금성면 탑리길",
